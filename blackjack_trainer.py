...
class BlackjackTrainer:
    ...
    def coverage(self):
        return (
            len(self.agent.observation_to_action_to_value) / self.observation_space_size
        )
    ...
    def play_with_exploitation_only(self, episode_count=None):
        episode_count_ = self.episode_count if episode_count is None else episode_count
